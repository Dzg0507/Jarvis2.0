...
(0, vitest_1.describe)('Tool Overhaul', () => {
    (0, vitest_1.describe)('fs_read tool', () => {
        ...
        (0, vitest_1.beforeEach)(async () => {
            const { default: toolDefinition } = await Promise.resolve().then(() => __importStar(require('./definitions/fs_read.js')));
    ...
    (0, vitest_1.describe)('web_search tool', () => {
        ...
        (0, vitest_1.beforeEach)(async () => {
            ...
            const { default: toolDefinition } = await Promise.resolve().then(() => __importStar(require('./definitions/web_search.js')));
